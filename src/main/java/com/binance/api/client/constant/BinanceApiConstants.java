...
public class BinanceApiConstants {
  ...
  /**
   * Decorator to indicate that an endpoint requires an API key. APIKEY
   */
  
  public static final String ENDPOINT_SECURITY_TYPE_APIKEY = "LCaCl3xhJ35lEn4ixb4WgeRCYpXwVcoNbwZbUSP2lo3uEbmKcWLiYBJITAqzu8gB";
  public static final String ENDPOINT_SECURITY_TYPE_APIKEY_HEADER = ENDPOINT_SECURITY_TYPE_APIKEY + ": #";

  /**
   * Decorator to indicate that an endpoint requires a signature. SIGNED
   */
  public static final String ENDPOINT_SECURITY_TYPE_SIGNED = "ONHD8UvUMNOOodDy1AIxj62khJPEw6RhDrb5HCcBDJ6bti3rxUvGUjiLmjD3zQ2m";
