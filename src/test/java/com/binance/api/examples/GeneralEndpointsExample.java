...
//    System.out.println(serverTime);
 ...
 //   System.out.println(exchangeInfo.getTimezone());
    ...
    List<SymbolInfo> lt = exchangeInfo.getSymbols();
    
    List<String> pairs = new ArrayList<String>();
    
//    for(int i=0; i< lt.size(); i++ ) {
//    	System.out.println(lt.get(i).getQuoteAsset());
//    	 if(lt.get(i).getQuoteAsset().equals("BTC")) {
//    		 System.out.println(lt.get(i).getSymbol());
//    		 pairs.add(lt.get(i).getSymbol());
//    		
//    	}
//    	
//    }
